...
11. 后台 `/admin/dashboard` 提供工单运营看板基础版，默认查看近 7 天，可按今日、近 7 天、本月、上月或自定义日期范围筛选，并支持门店、需求类型、状态和处理人多选；看板展示工单总览、SLA 指标、门店问题排行、需求类型排行、处理人效率和自动分派效果，所有指标都会按当前账号 `data_scope` 自动收敛。
